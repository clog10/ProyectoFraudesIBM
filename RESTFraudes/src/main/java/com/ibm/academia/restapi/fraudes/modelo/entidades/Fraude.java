...
public class Fraude implements Serializable{
	...
	public Fraude(Long id, String ip,String nombrePais,String codigoIso, String monedaLocal,BigDecimal cotizacionEuro, String usuarioCreacion) {
		this.id = id;
		this.ip = ip;
	...
	private static final long serialVersionUID = 7944844380526484234L;
